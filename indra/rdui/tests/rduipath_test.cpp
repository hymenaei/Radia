...
template<> template<> void rduipath_object::test<2>() {
    rdui::Path curve;
...
template<> template<> void rduipath_object::test<3>() {
...
template<> template<> void rduipath_object::test<4>() {
...
template<> template<> void rduipath_object::test<5>() {
