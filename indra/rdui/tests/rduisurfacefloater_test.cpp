...
namespace tut
{
    ...
    template<> template<>
    void rduisurfacefloater_object::test<1>()
    {
        rdui::StyleSheet style_sheet;
        ensure("floater drag style compiles", style_sheet.loadRadia(
            "floater { flow: column; } floater::header { height: 30px; } floater::content { flex-grow: 1; }").ok());
    ...
    template<> template<>
    void rduisurfacefloater_object::test<2>()
    {
        rdui::StyleSheet style_sheet;
        ensure("minimized restore style compiles", style_sheet.loadRadia(
            "floater { flow: column; } floater::header { height: 30px; flow: row; } floater::content { flex-grow: 1; }").ok());
        rdui::Surface surface(style_sheet);
        surface.setViewport(200.f, 200.f);
        auto floater = std::make_unique<rdui::Floater>();
        rdui::Floater* target = floater.get();
    ...
    template<> template<>
    void rduisurfacefloater_object::test<3>()
    {
        rdui::Surface first;
        rdui::Surface second;
    ...
    template<> template<>
    void rduisurfacefloater_object::test<4>()
    {
        rdui::StyleSheet style_sheet;
        ensure("startup Floater stylesheet compiles", style_sheet.loadRadia(
    ...
    template<> template<>
    void rduisurfacefloater_object::test<5>()
    {
        rdui::StyleSheet style_sheet;
        ensure("resize stylesheet compiles", style_sheet.loadRadia(
    ...
    template<> template<>
    void rduisurfacefloater_object::test<6>()
    {
    ...
    template<> template<>
    void rduisurfacefloater_object::test<7>()
    {
        rdui::StyleSheet style_sheet;
        ensure("percentage minimum compiles", style_sheet.loadRadia(
    ...
    template<> template<>
    void rduisurfacefloater_object::test<8>()
    {
        rdui::Surface surface;
    ...
    template<> template<>
    void rduisurfacefloater_object::test<9>()
    {
        rdui::Surface surface;
        surface.setViewport(200.f, 160.f);
        auto floater = std::make_unique<rdui::Floater>();
    ...
    template<> template<>
    void rduisurfacefloater_object::test<10>()
    {
        rdui::StyleSheet style_sheet;
        ensure("fixed outer floater stylesheet compiles", style_sheet.loadRadia(
            "floater { size: 300px; flow: column; } "
            "floater::header { height: 20px; } "
            "floater::content { flow: column; }").ok());
        rdui::Surface surface(style_sheet);
