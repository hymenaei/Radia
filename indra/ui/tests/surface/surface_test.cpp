...
public:
    ...
    bool defaultPointerEvents() const override { return true; }
    bool focusable() const override { return true; }
    void paint(radia::ui::PaintContext&, const radia::ui::Style&, float) const override { ++paints; }
...
public:
    ...
    bool defaultPointerEvents() const override { return true; }
    bool focusable() const override { return true; }
    void paint(radia::ui::PaintContext&, const radia::ui::Style&, float) const override { mPaintOrder.push_back(mName); }
