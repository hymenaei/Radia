...
namespace tut
{
    ...
    void rduisurface_object::test<4>()
    {
        ...
        style_sheet.loadRadia("floater { flow: column; } floater::header { height: 30px; } floater::content { flex-grow: 1; } label { height: 20px; }");
    ...
    {
        rdui::StyleSheet style_sheet;
        ensure("pointer policy stylesheet compiles", style_sheet.loadRadia(
    ...
    {
        rdui::StyleSheet style_sheet;
        ensure("automatic layout stylesheet compiles", style_sheet.loadRadia(
    ...
    {
        rdui::StyleSheet style_sheet;
        ensure("cursor stylesheet compiles", style_sheet.loadRadia(
        ...
        ensure("explicit auto cursor compiles", style_sheet.loadRadia(
        ...
        ensure("cursor override compiles", style_sheet.loadRadia(
    ...
    void rduisurface_object::test<23>()
    {
        ...
        ensure("visible overflow compiles", stylesheet.loadRadia(
    ...
    {
        rdui::StyleSheet style_sheet;
        ensure("state layout stylesheet compiles", style_sheet.loadRadia(
