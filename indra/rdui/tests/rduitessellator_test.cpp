...
namespace tut
{
    ...
    template<> template<>
    void rduitessellator_object::test<1>()
    {
    ...
    template<> template<>
    void rduitessellator_object::test<2>()
    {
    ...
    template<> template<>
    void rduitessellator_object::test<3>()
    {
    ...
    template<> template<>
    void rduitessellator_object::test<4>()
    {
        rdui::Path curve;
    ...
    template<> template<>
    void rduitessellator_object::test<5>()
    {
