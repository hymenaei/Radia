...
template<> template<> void rduilayout_object::test<2>() {
    rdui::StyleSheet theme;
    theme.loadRadia("button { width: 128px; height: 32px; padding: 7px; gap: 6px; flow: row; justify-content: center; "
                    "line-height: 18px; } button > icon { "
                    "size: 14px; }");
    rdui::Panel root;
    root.setRect({0.f, 0.f, 300.f, 200.f});
    auto button = std::make_unique<rdui::Button>();
...
template<> template<> void rduilayout_object::test<3>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<4>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<5>() {
    rdui::StyleSheet theme;
    theme.loadRadia("floater { padding: 10px; flow: column; } floater::header { height: 30px; } floater::content { "
                    "flex-grow: 1; }"
...
template<> template<> void rduilayout_object::test<6>() {
    rdui::StyleSheet theme;
    theme.loadRadia("floater { flow: column; } floater::header { height: 30px; } floater::content { flex-grow: 1; } label { "
                    "height: 20px; }");
    rdui::Floater floater;
    floater.setTitle("title").setRect({0.f, 0.f, 100.f, 100.f});
    floater.addChild(std::make_unique<rdui::Label>("content"));
...
template<> template<> void rduilayout_object::test<7>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<8>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<9>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<10>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<11>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<12>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<13>() {
    rdui::StyleSheet theme;
    rdui::Panel panel;
...
template<> template<> void rduilayout_object::test<14>() {
    rdui::StyleSheet theme;
    ...
    ensure("switch part layout compiles",
           theme
               .loadRadia("switch { width: 64px; height: 32px; padding: 3px 5px; flow: column; justify-content: center; } "
    ...
    ensure_equals("thumb radius comes from part style", rdui::resolveWidgetStyle(theme, *control.thumb()).border_radius, 7.f);

    control.setChecked(true);
    rdui::layoutTree(control, theme, text);
    ensure_equals("checked widget fixes alignment to end", static_cast<int>(rdui::resolveWidgetStyle(theme, control).justify_content),
...
template<> template<> void rduilayout_object::test<15>() {
...
template<> template<> void rduilayout_object::test<16>() {
    rdui::StyleSheet theme;
    ensure("direction stylesheet compiles",
           theme
               .loadRadia("panel { flow: row; justify-content: start; gap: 5px; } "
                          "label { width: 10px; height: 10px; } #physical { margin: 0px 7px 0px 0px; }")
               .ok());
    rdui::Panel panel;
    panel.setRect({0.f, 0.f, 100.f, 20.f});
    panel.addChild(std::make_unique<rdui::Label>("first"));
...
template<> template<> void rduilayout_object::test<17>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<18>() {
    rdui::StyleSheet theme;
    ensure("field container stylesheet compiles",
           theme
               .loadRadia("field { flow: column; } "
...
template<> template<> void rduilayout_object::test<19>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<20>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<21>() {
    rdui::StyleSheet theme;
    ensure("automatic floater size stylesheet compiles",
           theme
               .loadRadia("floater { size: auto 100px; flow: column; } "
...
template<> template<> void rduilayout_object::test<22>() {
    rdui::StyleSheet theme;
    ensure("row alignment stylesheet compiles",
           theme
               .loadRadia("panel { flow: row; align-items: start; } label { width: 10px; height: 10px; } "
    ...
    ensure("column alignment stylesheet compiles",
           theme
               .loadRadia("panel { flow: column; align-items: start; } label { width: 10px; height: 10px; } "
                          "label#center { align-self: center; } label#end { align-self: end; } "
...
template<> template<> void rduilayout_object::test<23>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<24>() {
    rdui::StyleSheet theme;
    ensure("vertical container alignment stylesheet compiles",
           theme
               .loadRadia("panel { size: 40px 100px; flow: row; } label { size: 10px; } "
    ...
    auto add_label = [](rdui::Widget& container) { container.addChild(std::make_unique<rdui::Label>("child")); };
    ...
    ensure_equals("free-flow unpositioned content follows vertical alignment", free_bottom.children()[0]->rect().bottom(), 0.f);
    ...
    ensure_equals("authored Button vertical alignment overrides its intrinsic default", top_button.children()[0]->rect().top(), 40.f);
}

template<> template<> void rduilayout_object::test<25>() {
    rdui::StyleSheet theme;
...
template<> template<> void rduilayout_object::test<26>() {
    rdui::StyleSheet theme;
    ...
    rdui::StyleSheet percentage_theme;
           ...
           percentage_theme.loadRadia("panel { flow: row; } label { width: 30px; flex-basis: 50%; }").ok());
...
template<> template<> void rduilayout_object::test<27>() {
    rdui::StyleSheet theme;
    ensure("floater header stylesheet compiles",
           theme
               .loadRadia("floater::header { height: 48px; flow: row; padding: 12px; } "
    ...
    for (const auto& child : floater.header()->children()) {
        ...
        ensure_equals("an oversized header icon does not pull the row below center", child_center, header_center);
    }
}

template<> template<> void rduilayout_object::test<28>() {
    rdui::StyleSheet theme;
    ensure("explicit wrapping stylesheet compiles",
           theme
               .loadRadia("panel { flow: column; } "
...
template<> template<> void rduilayout_object::test<29>() {
    rdui::StyleSheet theme;
    ensure("row wrapping stylesheet compiles",
           theme
               .loadRadia("panel { width: 45px; flow: row; align-items: start; } "
...
template<> template<> void rduilayout_object::test<30>() {
    rdui::StyleSheet column_theme;
    ensure("column basis stylesheet compiles",
           column_theme
               .loadRadia("panel { width: 30px; flow: column; } "
                          "text { flex-basis: 40px; font-size: 10px; "
                          "line-height: 10px; text-wrap: wrap; }")
               .ok());
    rdui::Panel column;
    column.addChild(std::make_unique<rdui::Text>("alpha beta"));
    ensure_equals("column measurement reapplies flex-basis after text reflow", rdui::measureWidget(column, column_theme, text).y, 40.f);

    rdui::StyleSheet row_theme;
    ensure("row intrinsic minimum stylesheet compiles",
           row_theme
               .loadRadia("panel { width: 80px; flow: row; } "
                          "text { flex: 0 1 100px; font-size: 10px; "
                          "line-height: 10px; text-wrap: wrap; } "
                          "label { width: 10px; flex-shrink: 0; }")
               .ok());
    rdui::Panel row;
