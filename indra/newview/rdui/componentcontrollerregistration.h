/**
 * @file componentcontrollerregistration.h
 * @brief Defines the ComponentController event registration templates.
 *
...
#ifndef RD_COMPONENTCONTROLLER_REGISTRATION_H
#define RD_COMPONENTCONTROLLER_REGISTRATION_H
