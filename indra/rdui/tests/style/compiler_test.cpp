...
template<> template<> void compilerObject::test<6>() {
    ...
    ensure_equals("pointer enum", static_cast<int>(panel.pointerEvents), static_cast<int>(rdui::PointerEvents::PassThrough));
    const rdui::Style label = theme.resolve("label", "", {}, 0);
    ensure_equals("horizontal enum", static_cast<int>(label.textAlign), static_cast<int>(rdui::TextAlign::Right));
    ensure_equals("container vertical enum", static_cast<int>(panel.verticalAlign), static_cast<int>(rdui::VerticalAlign::Middle));
    ensure_equals("vertical alignment remains local", static_cast<int>(label.verticalAlign), static_cast<int>(rdui::VerticalAlign::Top));
    ensure_equals("auto pointer enum", static_cast<int>(label.pointerEvents), static_cast<int>(rdui::PointerEvents::Auto));
...
template<> template<> void compilerObject::test<7>() {
    ...
    ensure_equals("font family", static_cast<int>(a.fontFamily), static_cast<int>(rdui::FontFamily::Sans));
    ensure_equals("font size", a.fontSize, 19.f);
    ensure_equals("bold", a.fontWeight, static_cast<U16>(700));
    ensure("italic", a.fontItalic);

    rdui::StyleSheet variableWeight;
...
template<> template<> void compilerObject::test<8>() {
    ...
    rdui::Button button;
    rdui::Icon& buttonIcon = button.setIcon("search");
    const rdui::Style icon = rdui::resolveWidgetStyle(theme, buttonIcon);
    ensure("svg width is set", icon.svgStrokeWidth.has_value());
    ensure_equals("svg width", icon.svgStrokeWidth->pixels, 4.f);
    ensure_equals("cap", static_cast<int>(icon.svgStrokeCap), static_cast<int>(rdui::StrokeCap::Square));
}
...
template<> template<> void compilerObject::test<12>() {
    ...
    ensure_equals("default justification", static_cast<int>(style.justifyContent), static_cast<int>(rdui::JustifyContent::Start));
    ensure_equals("default container alignment", static_cast<int>(style.alignItems), static_cast<int>(rdui::AlignItems::Normal));
    ensure_equals("default flow-item alignment", static_cast<int>(style.alignSelf), static_cast<int>(rdui::AlignSelf::Auto));
    ...
    ensure_equals("default pointer behavior", static_cast<int>(style.pointerEvents), static_cast<int>(rdui::PointerEvents::Default));
    ensure_equals("default font", static_cast<int>(style.fontFamily), static_cast<int>(rdui::FontFamily::Sans));
    ensure_equals("default container vertical alignment is top", static_cast<int>(style.verticalAlign), static_cast<int>(rdui::VerticalAlign::Top));
    rdui::StyleSheet buttonTheme;
    rdui::Button button;
    const rdui::Style buttonDefaults = rdui::resolveWidgetStyle(buttonTheme, button);
    ensure_equals("Button intrinsically uses row flow", static_cast<int>(buttonDefaults.flow), static_cast<int>(rdui::Flow::Row));
    ...
    const rdui::Style authoredButton = rdui::resolveWidgetStyle(buttonTheme, button);
    ...
    rdui::StyleSheet floaterTheme;
    rdui::Floater floater;
    rdui::Panel* customHeader = nullptr;
    for (const auto& child : floater.header()->children())
        if (child->part() == "header::custom") customHeader = static_cast<rdui::Panel*>(child.get());
    ...
    ensure_equals("Floater header intrinsically aligns content to the middle",
                  static_cast<int>(rdui::resolveWidgetStyle(floaterTheme, *floater.header()).verticalAlign),
                  static_cast<int>(rdui::VerticalAlign::Middle));
    ensure_equals("Floater custom header intrinsically aligns content to the middle",
                  static_cast<int>(rdui::resolveWidgetStyle(floaterTheme, *customHeader).verticalAlign),
                  static_cast<int>(rdui::VerticalAlign::Middle));

    rdui::StyleSheet fieldTheme;
    rdui::Field field;
    ensure_equals("Field intrinsically aligns content to the middle", static_cast<int>(rdui::resolveWidgetStyle(fieldTheme, field).verticalAlign),
                  static_cast<int>(rdui::VerticalAlign::Middle));
    ...
    ensure_equals("authored Field vertical alignment overrides its intrinsic default",
                  static_cast<int>(rdui::resolveWidgetStyle(fieldTheme, field).verticalAlign), static_cast<int>(rdui::VerticalAlign::Bottom));
...
template<> template<> void compilerObject::test<13>() {
    ...
    ensure_equals("text-wrap inherits", static_cast<int>(inherited.textWrap), static_cast<int>(rdui::TextWrap::NoWrap));
    ensure_equals("text-overflow remains local", static_cast<int>(inherited.textOverflow), static_cast<int>(rdui::TextOverflow::EllipsisCenter));
...
template<> template<> void compilerObject::test<15>() {
    ...
    const std::optional<std::size_t> close = rdui::detail::matchingBlock(kSource, open);
