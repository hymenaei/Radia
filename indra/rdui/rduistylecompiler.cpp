...
namespace rdui
{
    namespace
    {
        ...
        constexpr StylePropertyDescriptor PROPERTY_DESCRIPTORS[] = {
            {StyleProperty::BackgroundColor,  "background-color", StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Paint},
            {StyleProperty::Border,           "border",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Border},
            {StyleProperty::BorderColor,      "border-color",     StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Paint},
            {StyleProperty::BorderRadius,     "border-radius",    StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Number},
            {StyleProperty::BorderWidth,      "border-width",     StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Edges},
            {StyleProperty::Bottom,           "bottom",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            ...
            {StyleProperty::Effect,           "effect",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Effects},
            {StyleProperty::Height,           "height",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Dimension},
            {StyleProperty::Left,             "left",             StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::Margin,           "margin",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Margin},
            {StyleProperty::MinHeight,        "min-height",       StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::MinSize,          "min-size",         StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::MinWidth,         "min-width",        StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::Opacity,          "opacity",          StyleCapability::Box,        StylePropagation::Composited, InheritedStyleProperty::None,       StyleValueType::Number},
            {StyleProperty::Outline,          "outline",          StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Outline},
            {StyleProperty::Overflow,         "overflow",         StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Overflow},
            {StyleProperty::Padding,          "padding",          StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Edges},
            {StyleProperty::PointerEvents,    "pointer-events",   StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::PointerEvents},
            {StyleProperty::Right,            "right",            StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::Shadow,           "shadow",           StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Shadows},
            {StyleProperty::Size,             "size",             StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Size},
            {StyleProperty::Top,              "top",              StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
            {StyleProperty::Width,            "width",            StyleCapability::Box,        StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Dimension},
            {StyleProperty::AlignItems,       "align-items",      StyleCapability::Container,  StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::AlignItems},
            {StyleProperty::Flow,             "flow",             StyleCapability::Container,  StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Flow},
            {StyleProperty::Gap,              "gap",              StyleCapability::Container,  StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Gap},
            {StyleProperty::JustifyContent,   "justify-content",  StyleCapability::Container,  StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::JustifyContent},
            {StyleProperty::AlignSelf,        "align-self",       StyleCapability::FlowItem,   StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::AlignSelf},
            {StyleProperty::Grow,             "grow",             StyleCapability::FlowItem,   StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Number},
            {StyleProperty::Order,            "order",            StyleCapability::FlowItem,   StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Integer},
            ...
            {StyleProperty::VerticalAlign,    "vertical-align",   StyleCapability::Text,       StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::VerticalAlign},
            {StyleProperty::IconStroke,       "stroke",           StyleCapability::Icon,       StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::IconStroke},
            {StyleProperty::IconStrokeColor,  "stroke-color",     StyleCapability::Icon,       StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Color},
            {StyleProperty::IconStrokeLinecap,"stroke-linecap",   StyleCapability::Icon,       StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::StrokeCap},
            {StyleProperty::IconStrokeWidth,  "stroke-width",     StyleCapability::Icon,       StylePropagation::Local,      InheritedStyleProperty::None,       StyleValueType::Length},
        };
    ...
    void detail::applyStyleDeclaration(Style& style, const StyleDeclaration& declaration)
    {
        switch (declaration.property)
        {
            ...
            case StyleProperty::Flow: style.flow = std::get<Flow>(declaration.value); break;
            case StyleProperty::Gap: style.gap = std::get<GapValue>(declaration.value); break;
            case StyleProperty::JustifyContent: style.justify_content = std::get<JustifyContent>(declaration.value); break;
            case StyleProperty::AlignSelf: style.align_self = std::get<AlignSelf>(declaration.value); break;
            case StyleProperty::Grow: style.grow = std::get<float>(declaration.value); break;
            ...
            case StyleProperty::VerticalAlign: style.vertical_align = std::get<VerticalAlign>(declaration.value); break;
        ...
        const std::string& source_name) const
    {
        ...
        switch (property)
        {
            ...
            case StyleProperty::FontFamily:
            {
                ...
                std::optional<FontFamily> parsed;
                if (family == "sans") parsed = FontFamily::Sans;
                else if (family == "sans-small" || family == "small") parsed = FontFamily::Small;
                else if (family == "sans-small-bold" || family == "small-bold") parsed = FontFamily::SmallBold;
                else if (family == "sans-small-italic" || family == "small-italic") parsed = FontFamily::SmallItalic;
                else if (family == "sans-medium" || family == "medium") parsed = FontFamily::Medium;
                else if (family == "sans-big" || family == "big" || family == "large") parsed = FontFamily::Big;
                else if (family == "sans-huge" || family == "huge") parsed = FontFamily::Huge;
                else if (family == "sans-bold" || family == "bold") parsed = FontFamily::Bold;
                return parsed ? compiled(*parsed) : invalid();
            }
            ...
            case StyleProperty::TextAlign:
            {
                ...
                else if (alignment == "center" || alignment == "middle") parsed = TextAlign::Center;
            ...
            case StyleProperty::VerticalAlign:
            {
                ...
                else if (alignment == "center" || alignment == "middle") parsed = VerticalAlign::Center;
            ...
            case StyleProperty::PointerEvents:
            {
                ...
                else if (policy == "none") parsed = PointerEvents::None;
